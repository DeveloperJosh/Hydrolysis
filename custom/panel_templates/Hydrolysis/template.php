...
/*
 ...
 | |_| | | | |/ _` | '__/ _ \| | | | / __| / __|
 |  _  | |_| | (_| | | | (_) | | |_| \__ \ \__ \
 |_| |_|\__, |\__,_|_|  \___/|_|\__, |___/_|___/
        |___/                   |___/           
	By Emerald
	
	
	NamelessMC made by Samerton
...
if(!class_exists('Hydrolysis_StaffCP')){
	class Hydrolysis_StaffCP extends TemplateBase {
		...
		public function __construct($cache, $smarty, $language, $user, $pages){
			...
			$this->addCSSFiles(array(
				...
				(defined('CONFIG_PATH') ? CONFIG_PATH : '') . '/custom/panel_templates/Hydrolysis/assets/css/adminlte.min.css' => array(),
				'https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,400i,700' => array(),
				(defined('CONFIG_PATH') ? CONFIG_PATH : '') . '/custom/panel_templates/Hydrolysis/assets/css/custom.css' => array(),
			));

			$this->addJSFiles(array(
				(defined('CONFIG_PATH') ? CONFIG_PATH : '') . '/custom/panel_templates/Hydrolysis/assets/plugins/jquery/jquery.min.js' => array(),
				(defined('CONFIG_PATH') ? CONFIG_PATH : '') . '/core/assets/js/jquery.cookie.js' => array(),
				(defined('CONFIG_PATH') ? CONFIG_PATH : '') . '/custom/panel_templates/Hydrolysis/assets/plugins/bootstrap/js/bootstrap.bundle.min.js' => array(),
				(defined('CONFIG_PATH') ? CONFIG_PATH : '') . '/custom/panel_templates/Hydrolysis/assets/js/adminlte.min.js' => array()
			));
			...
			if(defined('PANEL_PAGE')){
				switch(PANEL_PAGE){
					...
					case 'page_metadata':
						if(!isset($_GET['id'])){
							$this->addCSSFiles(array(
								(defined('CONFIG_PATH') ? CONFIG_PATH : '') . '/custom/panel_templates/Hydrolysis/assets/css/dataTables.bootstrap4.min.css' => array()
							));

							$this->addJSFiles(array(
								(defined('CONFIG_PATH') ? CONFIG_PATH : '') . '/core/assets/plugins/dataTables/jquery.dataTables.min.js' => array(),
								(defined('CONFIG_PATH') ? CONFIG_PATH : '') . '/custom/panel_templates/Hydrolysis/assets/js/dataTables.bootstrap4.min.js' => array()
							));
...
$template = new Hydrolysis_StaffCP($cache, $smarty, $language, $user, $pages);
